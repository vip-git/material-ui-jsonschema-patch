...
function createGenerateClassName() {
  ...
  var _options$dangerouslyU = options.dangerouslyUseGlobalCSS,
      ...
      productionPrefix = _options$productionPr === void 0 ? 'nss' : _options$productionPr;
  var escapeRegex = /([[\].#*$><+~=|^:(),"'`\s])/g;
  ...
  if (process.env.NODE_ENV === 'production' && typeof window !== 'undefined' && productionPrefix === 'nss') {
    generatorCounter += 1;
